...
WITH RowNumCTE AS (
select *, ROW_NUMBER() over (partition by ParcelID, PropertyAddress, SalePrice, LegalReference order by uniqueID) AS ROWNUM
from NashvilleHousing
...
delete 
from RowNumCTE 
where ROWNUM > 1  -- and ofcourse you have to run this query write after the CTE
